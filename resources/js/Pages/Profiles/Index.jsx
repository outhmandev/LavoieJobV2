                                    ...
                                    <tr key={profile.id} className="hover:bg-gray-50/50 dark:hover:bg-gray-800/50 transition-colors group">
                                        ...
                                        <td className="py-4 px-6">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <Link href={route('profiles.edit', profile.id)} className="font-semibold text-gray-900 dark:text-white hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                                                        {profile.nom || profile.full_name || 'N/A'}
                                                    </Link>
