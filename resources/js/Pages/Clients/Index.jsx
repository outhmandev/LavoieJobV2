...
export default function Index({ clients, filters, options }) {
    ...
    const clearFilters = () => {
        const emptyFilters = { project_id: '', reference: '', nom: '', ville: '', statut: '', membre: '' };
        ...
        <AuthenticatedLayout
            header={
                <div className="flex flex-col md:flex-row md:items-center md:justify-between w-full">
                    <div>
                        <h2 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Clients Directory</h2>
                        <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Manage your agency clients and their projects.</p>
                    </div>
            ...
            <div className="mb-6 bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800/80 p-5">
                ...
                <form onSubmit={applyFilters}>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        {/* Reference Filter */}
                        <div>
                            <label className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">Reference (Matricule)</label>
                            <input 
                                type="text" 
                                name="reference" 
                    ...
                    <table className="w-full text-left border-collapse min-w-max">
                        <thead>
                            <tr className="bg-gray-50/80 dark:bg-gray-800/80 border-b border-gray-100 dark:border-gray-700/50">
                                <th className="py-4 px-6 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Client Name</th>
                                <th className="py-4 px-6 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Matricule / Ref</th>
                                <th className="py-4 px-6 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Project / Need</th>
                                <th className="py-4 px-6 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Status</th>
                                <th className="py-4 px-6 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Location</th>
                                        ...
                                        <Dropdown>
                                            ...
                                            <Dropdown.Content align="right" width="48">
                                                ...
                                                <Dropdown.Link href="#" as="button" className="flex items-center gap-2 text-rose-600 hover:bg-rose-50">
                                                    <FiTrash2 className="text-rose-500" /> Delete Client
                                                </Dropdown.Link>
                                            </Dropdown.Content>
                                        </Dropdown>
                                    </td>
                                ...
                                <tr>
                                    <td colSpan="6" className="py-12 text-center">
                                        <div className="flex flex-col items-center justify-center text-gray-500">
                                            ...
                                            <p className="text-sm mt-1 mb-4">Try adjusting your filters or create a new client.</p>
